            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="select_role" >{{$product_images[$i]}}</label>
                                <input type='file' class="form-control" id="imageUpload" name="photo[]" accept=".png, .jpg, .jpeg" value=""/>
                                <input type='hidden' class="form-control" id="imageUpload" name="prev_photo[]" accept=".png, .jpg, .jpeg" value="{{$product_images[$i]}}"/>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
